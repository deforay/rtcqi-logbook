                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body mt-0 pt-0">
                                ...
                                <form class="form form-horizontal" role="form"  name="returnissueitems" id="returnissueitems" method="post" action="/inventoryoutwards/returnissueitems" autocomplete="off" onsubmit="validateNow();return false;">
                                @csrf
                                <br/>
                                <div class="row">
                                    <div class="">
...
function validateNow() {
    ...
    flag = deforayValidator.init({
        formId: 'returnissueitems'
    });
    if (flag == true) {
        $('.itemQty').prop('disabled',false)
        if (duplicateName) {
            document.getElementById('returnissueitems').submit();
        }
    }
    else{
