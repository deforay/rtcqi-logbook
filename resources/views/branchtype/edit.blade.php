				...
				<div class="card">
					...
					<div class="card-content collapse show">
						...
						<div id="show_alert"  class="mt-1" style=""></div>
                            <form class="form form-horizontal" role="form" name="editBranchType" id="editBranchType" method="post" action="/branchtype/edit/{{base64_encode($result[0]->branch_type_id)}}" autocomplete="off" onsubmit="validateNow();return false;">
                            @csrf
                            @php
                                $fnct = "branch_type_id##".($result[0]->branch_type_id);
                            @endphp
                                <div class="row">
 ...
 duplicateName = true;
    function validateNow() {
        flag = deforayValidator.init({
            formId: 'editBranchType'
        });
        
        if (flag == true) {
            if (duplicateName) {
                document.getElementById('editBranchType').submit();
            }
        }
        else{
