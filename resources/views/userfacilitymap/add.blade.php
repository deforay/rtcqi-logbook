<!-- 
    Author             : Sakthivel P
    Date               : 2 June 2021
    Description        : User Facility Map add screen
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h4 class="form-section"><i class="la la-plus-square"></i> Add User Facility</h4>
					...
					<div class="card-content collapse show">
						...
						<div id="show_alert"  class="mt-1" style=""></div>
                            <form class="form form-horizontal" role="form" name="addUserFacility" id="addUserFacility" method="post" action="/userfacilitymap/add" autocomplete="off" onsubmit="validateNow();return false;">
                            @csrf
                                <div class="row">
                                <div class="col-xl-4 col-lg-12">
                                    ...
                                    <div class="col-xl-4 col-lg-12">
										<fieldset>
                                            ...
                                            <div class="form-group">
                                                <select multiple class="form-control isRequired" autocomplete="off" style="width:100%;" id="facilityId" name="facilityId[]" title="Please select Facility Name">
 ...
 duplicateName = true;
    function validateNow() {
            flag = deforayValidator.init({
                formId: 'addUserFacility'
            });
            
            if (flag == true) {
                if (duplicateName) {
                    document.getElementById('addUserFacility').submit();
                }
            }
            else{
