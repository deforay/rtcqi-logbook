...
<div class="content-wrapper">
  <div class="content-header row">
    <div class="content-header-left col-md-10 col-12 mb-2 breadcrumb-new">
      <h3 class="content-header-title mb-0 d-inline-block">Mail Template Details</h3>
        ...
        <div class="card-content collapse show">
          <div class="card-body">
            <div class="table-responsive p-t-10">
              <table class="table table-striped table-bordered custom-toolbar-elements" id="mailtemplateList">
                <thead>
                  <tr>
                    <th>Template Name</th>
                    <th>From Name</th>
                    <th>From Name Mail Id</th>
                    <th>Mail cc</th>
                    <th>Mail Bcc</th>
                    <th>Subject</th>
                    <th>Action</th>
