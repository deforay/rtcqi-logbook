                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="form form-horizontal" role="form" name="addDistrict" id="addDistrict" method="post" action="/district/add" autocomplete="off" onsubmit="validateNow();return false;">
                                    @csrf
                                    <div class="row">
...
<script>
    ...
    function validateNow() {
        ...
        if (flag == true) {
            if (duplicateName) {
                document.getElementById('addDistrict').submit();
            }
        } else {
