                                    ...
                                    <div class="col-xl-4 col-lg-12">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="districtName" value="{{$result[0]->district_name}}" class="form-control isRequired" autocomplete="off" placeholder="Enter District Name" name="districtName" title="Please Enter District Name" >
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-4 col-lg-12">
