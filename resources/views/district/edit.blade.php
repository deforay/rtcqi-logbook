                                    ...
                                    <div class="col-xl-4 col-lg-12">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="districtName" value="{{$result[0]->district_name}}" class="form-control" autocomplete="off" placeholder="Enter district name" name="districtName" title="Please enter district name" >
                                            </div>
                                        </fieldset>
                                    </div>
                                    <div class="col-xl-4 col-lg-12">
