<!-- 
    Author             : Prasath M
    Date               : 18 June 2020
    Description        : Item Type view screen
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h3 class="content-header-title mb-0">Item Type Details</h3>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration" id="itemTypeList">
                                        <thead>
                                            <tr>
    ...
    function getAllItemType()
    {
      ...
      $('#itemTypeList').DataTable({
            ...
            columns: [
                    ...
                    { data: 'item_type_status', name: 'item_type_status',className:'firstcaps' },
