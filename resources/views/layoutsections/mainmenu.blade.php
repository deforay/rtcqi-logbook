        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="index.html" data-toggle="dropdown"><i class="la la-home"></i><span data-i18n="Dashboard">Dashboard</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li data-menu=""><a class="dropdown-item" href="dashboard-crypto.html" data-toggle=""><i class="la la-sitemap"></i><span data-i18n="Crypto">Crypto</span></a>
                    </li>
                    <li data-menu=""><a class="dropdown-item" href="dashboard-sales.html" data-toggle=""><i class="la la-dollar"></i><span data-i18n="Sales">Sales</span></a>
                    </li>
                </ul>
            </li>
