...
$import = '';
    ...
    $manage .= '<li id="li-testkit"><a class="dropdown-item" data-toggle="dropdown" href="/testkit/">Test Kit</a></li>';
    $manage .= '<li id="li-facility"><a class="dropdown-item" data-toggle="dropdown" href="/facility/">Facility</a></li>';
    $manage .= '<li id="li-province"><a class="dropdown-item" data-toggle="dropdown" href="/province/">Province</a></li>';
