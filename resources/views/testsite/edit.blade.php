                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-12">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" id="country" value="{{$result[0]->site_country}}" class="form-control" autocomplete="off" placeholder="Enter Country" name="country" title="Please Enter Country">
                                                </div>
                                            </fieldset>
                                        </div>
                                        <div class="col-xl-4 col-lg-12">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" id="city" value="{{$result[0]->site_city}}" class="form-control" autocomplete="off" placeholder="Enter City" name="city" title="Please Enter City">
                                                </div>
                                            </fieldset>
                                        </div>
                                        <div class="col-xl-4 col-lg-12">
