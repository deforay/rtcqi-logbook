                                                ...
                                                <table class="table table-striped table-bordered table-condensed table-responsive-lg">
                                                    ...
                                                    <tbody id="orderDetails">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" min="0" value="{{$quotesDetail->quantity}}" id="quoteQty{{$z}}" name="quoteQty[]" class="form-control isRequired" placeholder="Order Qty" title="Please enter the order qty" />
                                                            </td>
                                                            <td>
