<table style="border: 3px solid black">
    ...
    <tr style="border: 3px solid black">
        <td colspan="5" style="border: 3px solid black;font-weight:bold;">Invalid Results Report</td>
      </tr></thead></table>
    ...
    <thead style="border: 3px solid black">
    <tr>
        <th colspan="5" style="border: 3px solid black;font-weight:bold;text-align: center;">Test {{$i}}</th>
      </tr>
    <tr style="border: 3px solid black">
    ...
    <tbody style="border: 3px solid black">
        ...
        <tr style="border: 3px solid black">
            <td style="border: 3px solid black">{{ $invalidresult->facility_name }}</td>
