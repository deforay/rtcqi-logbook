            ...
            <div class="row breadcrumbs-top d-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/trendreport/">{{ __('messages.trend_report') }}</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="content-header-title mb-0">{{ __('messages.trend_report') }}</h3>
                                        ...
                                        <div class ="row">
                                            ...
                                            <div class="col-md-7" style="color:#FFF;">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <button type="submit" onclick="getTrendReport();return false;" class="btn btn-info"> {{ __('messages.search') }}</button>&nbsp;&nbsp;
                                                        <a class="btn btn-danger btn-md" href='/trendreport/'><span>Reset</span></a>&nbsp;&nbsp;
                                                        <?php $role = session('role');
                                                        if (isset($role['App\\Http\\Controllers\\Report\\ReportController']['trendexport']) && ($role['App\\Http\\Controllers\\Report\\ReportController']['trendexport'] == "allow")) {?>
