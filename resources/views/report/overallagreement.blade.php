                                        ...
                                        <table class="table table-bordered " id="trendTable" style="width:100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Test</th>
                                                    @for($i = 1; $i <= $arr['no_of_test']; $i++) <th colspan="3" bgcolor="{{$col[$i]}}">Test{{$i}}</th>
                                                        @endfor
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @for($k = 0; $k < count($row); $k++) <tr>
                                                    <td>{{$row[$k]}}</td>
                                                    @for($j = 1; $j <= $arr['no_of_test']; $j++) <?php $lot_no = 'lot_no_' . $j;
                                                                                                    ...
                                                                                                    ?> @if($row[$k]=='Lot No' ) <td bgcolor="{{$col[$j]}}" colspan="3">{{$report[0]->$lot_no}}</td>
