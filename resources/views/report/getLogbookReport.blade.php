...
?>
        ...
        <td class = "td"style=" width: 10%; text-align: left; color: black;font-weight: 500;"><a href="/report/overallagreement/{{ base64_encode($trendrow->mrp_id)}}" name="overall_agreement" id="'.$data->mrp_id.'" class="" title="Overall Agreement">{{$trendrow->overall_agreement}}</a></td>
        </tr>
        @endforeach
