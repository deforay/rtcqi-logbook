...
<div class="content-header row">
	<div class="content-header-left col-md-10 col-12 mb-2 breadcrumb-new">
		<h3 class="content-header-title mb-0 d-inline-block">Change Language</h3>
		<div class="row breadcrumbs-top d-inline-block">
		<div class="breadcrumb-wrapper col-12">
			<ol class="breadcrumb">
			<li class="breadcrumb-item">Manage
			</li>
			<li class="breadcrumb-item active">Change Language</li>
			</ol>
		</div>
		</div>
	</div>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h4 class="form-section"><i class="la la-plus-square"></i> Change Language</h4>
                ...
                @endif
					<div class="card-content collapse show">
						...
						<form class="form form-horizontal" role="form" name="changelanguage" id="changelanguage" method="post" action="/changeLanguage" autocomplete="off" onsubmit="validateNow();return false;">
						@csrf
							<div class="row">
								<div class="col-xl-6 col-lg-12">
									<fieldset>
										<h5>Choose Language <span class="mandatory">*</span></h5>										
										<div class="form-group">
											<select class="form-control" autocomplete="off" style="width:100%;" id="locale" name="locale" title="Please Select Language">
                                                ...
                                                @foreach($available_locales as $locale_name => $available_locale)
                                                    ...
                                                    <option value="{{$available_locale}}" {{ $available_locale === $currentUserLanguage  ?  'selected':''}}>{{ $locale_name }}</option>
                                                    @endforeach
                                                </select>
										</div>
									</fieldset>
