            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/province/">{{ __('messages.implementing_partners') }}</a>
                        </li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="form-section"><i class="la la-plus-square"></i> {{ __('messages.add') }} {{ __('messages.implementing_partners') }}</h4>
                                        ...
                                        <div class="col-xl-4 col-lg-12">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" id="implementingPartnerName" class="form-control isRequired" autocomplete="off" placeholder="{{ __('messages.enter') }} {{ __('messages.implementing_partner_name') }}" name="implementingPartnerName" title="Please Enter {{ __('messages.implementing_partner_name') }}" onblur="checkNameValidation('implementing_partners','implementing_partner_name', this.id,'','Entered Implementing Partner Name is already exist.')">
                                                </div>
                                            </fieldset>
                                        </div>
                                        <div class="col-xl-4 col-lg-12">
