			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h4 class="form-section"><i class="la la-plus-square"></i> Add Brand</h4>
					...
					<div class="card-content collapse show">
						...
						<div id="show_alert"  class="mt-1" style=""></div>
                            <form class="form form-horizontal" role="form" name="addBrand" id="addBrand" method="post" action="/brand/add" autocomplete="off" onsubmit="validateNow();return false;">
                            @csrf
                                <div class="row">
...
<script>
 duplicateName = true;
    function validateNow() {
        ...
        if (flag == true) {
            if (duplicateName) {
                document.getElementById('addBrand').submit();
            }
        }
        else{
