<!-- 
    Author             : Sriram V
    Date               : 18 Jun 2020
    Description        : Country Edit screen
    Last Modified Date : 
    Last Modified Name : 
-->
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="form-section"><i class="la la-plus-square"></i>Edit Countries</h4>
						...
						<div class="card-content collapse show">
							<div class="card-body">
								...
								<form class="form form-horizontal" role="form" name="editcountries" id="editcountries" method="post" action="/countries/edit/{{base64_encode($countries[0]->country_id)}}" autocomplete="off" onsubmit="validateNow();return false;">
									@csrf
									@php
...
<script>
	...
	function validateNow() {
		flag = deforayValidator.init({
			formId: 'editcountries'
		});

		if (flag == true) {
			if (duplicateName) {
				document.getElementById('editcountries').submit();
			}
		} else {
