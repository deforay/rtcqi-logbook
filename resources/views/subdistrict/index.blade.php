            ...
            <div class="row breadcrumbs-top d-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/subdistrict/">{{ __('messages.sub_district') }}</a>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="dropdown float-md-right">
                ...
                if (isset($role['App\\Http\\Controllers\\SubDistrict\\SubDistrictController']['add']) && ($role['App\\Http\\Controllers\\SubDistrict\\SubDistrictController']['add'] == "allow")) { ?>
                    <a href="/subdistrict/add" class="btn btn-outline-info round box-shadow-1 px-2" id="btnGroupDrop1">
                        <b><i class="ft-plus icon-left"></i> {{ __('messages.add') }} {{ __('messages.sub_district') }}</b></a>
                <?php } ?>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="content-header-title mb-0">{{ __('messages.sub_district') }}</h3>
                            ...
                            <div class="card-body card-dashboard">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration" id="subDistrictList">
                                        <thead>
                                            <tr>
                                                <th>{{ __('messages.sub_district_name') }}</th>
                                                <th>{{ __('messages.district_name') }}</th>
                                                <th>{{ __('messages.province_name') }}</th>
                                                <th>{{ __('messages.province_id') }}</th>
                                                <th>{{ __('messages.dashboard') }}</th>
