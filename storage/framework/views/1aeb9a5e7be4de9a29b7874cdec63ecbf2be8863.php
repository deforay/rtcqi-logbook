...
background-color: #f2f3f5;
    ...
    <?php echo $__env->make('layoutsections.mainmenu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  function changeStatus(tableName, fieldIdName,fieldIdValue,fieldName, fieldVal, dataTableName)
    ...
    function checkNameValidation(tableName, fieldName, obj,fnct, msg)
    {
        ...
        if(checkValue!='')
        {
            ...
            $.ajax({
                url: "<?php echo e(url('/checkNameValidation')); ?>",
                method: 'post',
                data: {
...
<?php /**PATH /var/www/rtcqi-logbook/resources/views/layouts/main.blade.php ENDPATH**/ ?>