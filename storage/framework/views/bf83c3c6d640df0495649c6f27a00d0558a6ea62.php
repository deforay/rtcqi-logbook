...
<div class="content-header row">
	...
	<section class="horizontal-grid" id="horizontal-grid">
		<div class="row">
            ...
            <form class="form form-horizontal" role="form" name="changepassword" id="changepassword" method="post" action="/changePassword/<?php echo e($id); ?>" autocomplete="off" onsubmit="validateNow();return false;">
            <?php echo csrf_field(); ?>
			<?php
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/rtcqi-logbook/resources/views/login/changepassword.blade.php ENDPATH**/ ?>